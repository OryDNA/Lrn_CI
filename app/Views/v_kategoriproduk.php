    ...
    <tbody>
        <?php foreach ($product_category as $index => $product_category) : ?>
            <tr>
                ...
                <td><?php echo $product_category['kategori'] ?></td>
                <td>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('kategoriproduk/edit/' . $product_category['id']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="name">Kategori</label>
                                    <input type="text" name="kategori" class="form-control" id="kategori" value="<?= $product_category['kategori'] ?>" placeholder="Kategori barang" required>
                                </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary">Simpan</button>
